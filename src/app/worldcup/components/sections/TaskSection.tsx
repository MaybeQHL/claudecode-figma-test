...
import { tasks } from "@/app/worldcup/lib/data";
      ...
      <div className="space-y-2">
        {list.map((t) => (
          <motion.div
            ...
            layout
            onClick={() => toggle(t.id)}
            className={`flex cursor-pointer items-center gap-3 rounded-xl border p-3 transition-colors active:scale-[0.98] ${
              t.done
          ...
          >
            ...
            <motion.span
              ...
              className={`flex h-7 w-7 shrink-0 items-center justify-center rounded-full border-2 text-sm ${
                t.done ? "border-neon bg-neon text-black" : "border-white/20 text-transparent"
              }`}
            >
              ✓
            </motion.span>
